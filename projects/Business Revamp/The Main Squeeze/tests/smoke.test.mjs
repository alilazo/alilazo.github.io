...
const requiredCopy = [
  ...
  "Option #1 - My local Kyle price",
  "My local Kyle price",
  "$300 upfront",
  "$75/month",
  "Option #2 - Website + domain care",
  "$34.99/month",
  "GitHub hosting",
  "DNS setup",
  "themainsqueezekyle.com",
  "Option #3 - Let's talk",
  "I am open to talking about other options",
  "Competitors vs my rate",
  "Typical online freelancer",
  "$1,000-$5,000",
  "$50-$300/month",
  "My rate starts at $300 upfront",
  "108 S Front St",
